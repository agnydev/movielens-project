...
#############################################################################################
# Goal: 
# Prepare 10M MovieLens dataset.
# Create train(edx) and test(validation) sets.
# Conduct a first review of the datasets. 
# Visualize and show plots of interesting and important insights during data analysis.
# Build the models using Root Mean Square Error. 
# Train a machine learning algorithm using matrix factorization with 'recosystem' package. 
# Compute the best value of RMSE of the predicted ratings versus the actual ratings. 
#############################################################################################
...
# Predictions Output with regularization. RMSE result. 
...
## Let's see the top 5 best and top 5 worst movies reached by `recosystem` package
# Top 5 best movies 
